...
/* The sensor class, LIDAR is a surveying method that measures distance to a target
 by illuminating the target with laser light and measuring the reflected light with a sensor.
 */
public class Lidar {
	Drone drone;
	double degrees;
